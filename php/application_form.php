...
if ($conn->connect_error) {
    ...
    $query = "insert into $table (name, email, phone, gender, dob, job, city, qualification, employment, 
    experience, adhar, account) values ('$name','$email', '$phone', '$gender','$dob','$job','$city',
    '$qualification','$employment','$experience','$adhar','$account')";
